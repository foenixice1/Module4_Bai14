...
import com.codegym.formatter.ClassFormatter;
import com.codegym.service.Imp.ClassService;
import com.codegym.service.IClassService;
import com.codegym.service.IStudentService;
import com.codegym.service.Imp.StudentService;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new ClassFormatter(applicationContext.getBean(ClassService.class)));
    }
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/QLHocVien");
  ...
  @Bean
    public StudentValidate studentValidate() {
        return new StudentValidate();
    }
